...
// 1. Definisikan skema validasi produk menggunakan Zod
...
const AddProductPage = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        setApiError("Gagal memuat daftar kategori.");
      }
    };
    fetchCategories();
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 3. Kirim data yang valid ke backend
      await api.post("/products", result.data);
      alert("Produk baru berhasil ditambahkan!");
      // 4. Arahkan kembali ke dashboard produk
